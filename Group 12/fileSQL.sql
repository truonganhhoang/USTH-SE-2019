...
create table laphoadon(
	id_hoadon int auto_increment not null,
...
-- --
INSERT INTO `nhahang`.`nhanvien` (`id_nv`, `ten_nv`, `gioitinh`, `ngaysinh`, `quequan`, `cmnd`, `sdt`, `hesoluong`, `tendangnhap`, `t2`, `t3`, `t4`, `t5`, `t6`, `t7`, `cn`) VALUES ('1', 'Trang', 'Nữ', '1991-1-11', 'ha Nam', '123456789', '0987654321', '3', 'u1', '1', '1', '0', '0', '0', '0', '1');
INSERT INTO `nhahang`.`nhanvien` (`id_nv`, `ten_nv`, `gioitinh`, `ngaysinh`, `quequan`, `cmnd`, `sdt`, `hesoluong`, `tendangnhap`) VALUES ('2', 'Tâm', 'Nữ', '1991-01-11', 'Hà Nội', '123456777', '0988888888', '2', 'u2');
INSERT INTO `nhahang`.`nhanvien` (`id_nv`, `ten_nv`, `gioitinh`, `ngaysinh`, `quequan`, `cmnd`, `sdt`, `hesoluong`) VALUES ('3', 'Hòa', 'Nữ', '1991-01-11', 'Bắc Ninh', '32424', '324', '1');
...
INSERT INTO `nhahang`.`mathang` (`id_hang`, `tenmathang`, `chungloai`, `gia`, `soluong`) VALUES ('035', 'Snack o\'star', 'Đồ ăn', '5000', '20');
...
-- --
INSERT INTO `nhahang`.`laphoadon` (`id_nv`) VALUES ('1');
INSERT INTO `nhahang`.`laphoadon` (`id_nv`) VALUES ('2');
INSERT INTO `nhahang`.`laphoadon` (`id_nv`) VALUES ('2');
INSERT INTO `nhahang`.`laphoadon` (`id_nv`) VALUES ('1');
INSERT INTO `nhahang`.`laphoadon` (`thoigianlap`, `id_nv`) VALUES ('2018-12-2', '2');
INSERT INTO `nhahang`.`laphoadon` (`thoigianlap`, `id_nv`) VALUES ('2018-11-1', '1');

-- --
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('1', '2', '2');
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('1', '1', '4');
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('1', '3', '2');
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('2', '2', '3');
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('2', '1', '1');
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('3', '23', '1');
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('3', '1', '1');
INSERT INTO `nhahang`.`chitiethoadon` (`id_hoadon`, `id_hang`, `soluong`) VALUES ('4', '12', '1');
-- --